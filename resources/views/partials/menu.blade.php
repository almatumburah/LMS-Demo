<div class="sidebar">
    <nav class="sidebar-nav">
        ...
        <ul class="nav">
            ...
            @endcan
            <li class="nav-item">
                <a href="/registrants" class="nav-link" {{ request()->is('/registrants') || request()->is('/registrants/*') ? 'active' : '' }}>
            ...
            @can('discipline_access')
                <li class="nav-item">
                    <a href="/admin/requests" class="nav-link {{ request()->is('/requests') || request()->is('/requests*') ? 'active' : '' }}">
